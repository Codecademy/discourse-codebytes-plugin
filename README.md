...
1. [Click here to download the `.zip` from our `codecademy-discourse-theme` repo.](http://github.com/codecademy-engineering/codecademy-discourse-theme/archive/refs/heads/main.zip)
